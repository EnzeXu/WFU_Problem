    ...
    try:
        ...
        if path == '/getuser':
            ...
            if userid:
                ...
                response_headers += "Access-Control-Allow-Headers: content-security-policy, referrer-policy, upgrade-insecure-requests, content-type, access-control-allow-origin\r\n"
